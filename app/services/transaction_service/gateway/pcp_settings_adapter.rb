module TransactionService::Gateway
  class PcpSettingsAdapter < SettingsAdapter
    ...
    def tx_process_settings(opts_tx)
      ...
      p_set = PaymentSettingsStore.get_active_by_gateway(community_id: opts_tx[:community_id], payment_gateway: :pcp)
      Rails.logger.error(p_set)
